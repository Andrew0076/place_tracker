  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 5, 1, 79),
        actions: [
          Padding(
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: TextField(
        ...
        style: const TextStyle(fontSize: 20.0, color: Color.fromARGB(221, 0, 0, 0)),
        maxLines: null,
        autocorrect: true,
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: TextField(
        ...
        style: const TextStyle(fontSize: 20, color: Color.fromARGB(221, 0, 0, 0)),
        autocorrect: true,
        controller: controller,
        onChanged: (value) {
          onChanged(value);
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: 24,
                        fontWeight: FontWeight.bold,
                        color: Color.fromARGB(221, 8, 0, 0),
                      ),
                    ),
                    Icon(
                      Icons.star,
