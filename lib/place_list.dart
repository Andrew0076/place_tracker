  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        border: Border(
          bottom: BorderSide(
            color: selected ? const Color.fromARGB(255, 1, 54, 97) : const Color.fromARGB(0, 255, 255, 255),
          ),
        ),
      ),
      child: ButtonTheme(
        ...
        child: TextButton(
          child: Text(
            ...
            style: TextStyle(
              ...
              color: selected ? const Color.fromARGB(255, 1, 58, 105) : const Color.fromARGB(221, 12, 12, 12),
            ),
          ),
